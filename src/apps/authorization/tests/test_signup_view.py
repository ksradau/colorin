...
class Test(TestCase, TemplateResponseTestMixin):
    def test_sign_up_get(self):
        self.validate_response(
            url=f"/o/sign_up/",
            expected_view_name="authorization:sign_up",
            expected_template="authorization/sign_up.html",
    ...
    def test_sign_up_post(self):
        ...
        self.validate_response(
            ...
            method="post",
            form_data=form,
            expected_view_name="authorization:sign_up_confirmed",
            expected_template="authorization/sign_up_confirmed.html",
