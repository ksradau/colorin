...
from apps.authorization.views import ProfileEditView
from apps.authorization.views import ProfileView
...
class Test(TestCase, TemplateResponseTestMixin, UserTestMixin):
    def test_get_anonymous(self):
        self.validate_response(
            url="/o/me/edit/",
            expected_view_name="authorization:me_edit",
            expected_view=ProfileEditView,
            expected_template="authorization/me_edit.html",
